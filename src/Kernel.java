...
public class Kernel extends Thread {
    ...
    private Vector inMemVector = new Vector();
    ...
    public void step() {
        ...
        if (instruct.inst.startsWith("READ")) {
            ...
            if (page.physical == -1) {
                ...
                PageFault.replacePage(memVector, inMemVector, virtPageNum, Virtual2Physical.pageNum(instruct.addr, virtPageNum, block), controlPanel);
